...
config.General.requestName = 'PVINFO_QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8_'+day+'_'+version 
...
config.Data.outputDatasetTag = 'PVInfo_QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8_'+day+'_'+version
...
#Now using a different PTHat bin which is present on disk in AOD format
