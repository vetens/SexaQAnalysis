...
def main():
    ...
    if options.crabCmd == 'submit':
        ...
        config.General.workArea = 'crab_2018BPH_xEvt_trial'+trial
        
        config.section_('JobType') 
        config.JobType.pluginName = 'Analysis'
        config.JobType.psetName = '../treeproducer_data_Xevt_cfg.py'
        ...
        config.Data.outputDatasetTag = 'allSlices_2018BPH_xEvt_multicrab'
