...
config.General.requestName = 'SQRECO_IN_QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8_'+day+'_'+version 
...
config.Data.outputDatasetTag = 'SQRECO_IN_QCD_Pt-30to50_MuEnrichedPt5_TuneCP5_13TeV_pythia8_'+day+'_'+version
...
# NEW SAMPLE: Different pTHat bin which IS available on disk as AOD:
...
config.Site.whitelist = ['T2_US*','T3_US_FNALLPC']
