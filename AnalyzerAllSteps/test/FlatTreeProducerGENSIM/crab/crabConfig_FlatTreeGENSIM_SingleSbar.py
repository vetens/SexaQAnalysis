...
config.General.requestName = 'FlatTreeProducerGENSIM_SingleSbar_trial'+trial+'_'+mass+'_'+day+'_'+version

config.section_('JobType') 
config.JobType.pluginName = 'Analysis' 
config.JobType.psetName = '../FlatTreeProducerGENSIM_SingleSbarEvt_cfg.py' 
...
config.Data.outputPrimaryDataset = "FlatTreeProducerGENSIM_SingleSbar_trial"+trial+"_"+mass+"_"+day+'_'+version
