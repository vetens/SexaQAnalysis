...
#In case cuts on the number of Sbar generated per event are needed (For M2S reweighting)
process.load("SexaQAnalysis.AnalyzerAllSteps.FlatTreeProducerGENSIM_cfi")
process.FlatTreeProducerGENSIM.PUReweighting = cms.FileInPath("SexaQAnalysis/AnalyzerAllSteps/data/PUReweigh_SignalToDataBPH2018_FULL.txt")
process.FlatTreeProducerGENSIM.MC_MultiToSingleReweighting = cms.FileInPath("SexaQAnalysis/AnalyzerAllSteps/data/MultiToSingleSbar_NoReweigh.txt")
process.FlatTreeProducerGENSIM.runningOnData = runningOnData
process.FlatTreeProducerGENSIM.lookAtAntiS = lookAtAntiS
process.FlatTreeProducerGENSIM.SingleSbarOnly = True
...
process.flattreeproducer = cms.EndPath(process.FlatTreeProducerGENSIM)
