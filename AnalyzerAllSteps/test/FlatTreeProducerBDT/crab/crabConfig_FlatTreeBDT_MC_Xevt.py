...
config.General.requestName = 'FlatTreeProducerBDT_'+'XevtSQRECO_In_QCDSIM_'+'trial'+trial+'_'+mass+'_'+day+'_'+version

config.section_('JobType') 
config.JobType.pluginName = 'Analysis' 
config.JobType.psetName = '../FlatTreeProducerBDT_cfg_MC_XEvtReco.py' 
...
config.Data.outputPrimaryDataset = "FlatTreeProducerBDT_XevtSQ_In_QCD_Pt-170to300_MuEnrichedPt5_TuneCP5_13TeV_pythia8_"+day+'_'+version
