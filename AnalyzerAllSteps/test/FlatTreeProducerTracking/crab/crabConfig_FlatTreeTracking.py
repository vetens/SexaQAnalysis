...
config.Data.outLFNDirBase = '/store/user/wvetens/crmc_Sexaq/Skimmed/TrackingNtuple' 
...
config.Data.outputPrimaryDataset = "CRAB_AnalyzerAllSkimmed_SimSexaq_trial"+trial+"_TrackingNtuple_"+day+'_'+version
