...
#inlist = open("EDM_RECOSKIM_Trial5.txt")
...
process.FlatTreeProducerTracking.MC_MultiToSingleReweighting = cms.FileInPath("SexaQAnalysis/AnalyzerAllSteps/data/MultiToSingleSbar_1p8GeV_EtaReweigh.txt")
