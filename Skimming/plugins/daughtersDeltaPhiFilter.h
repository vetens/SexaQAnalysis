#ifndef daughtersDeltaPhiFilter_h
#define daughtersDeltaPhiFilter_h
...
class daughtersDeltaPhiFilter: public edm::EDFilter {

  public:

    explicit daughtersDeltaPhiFilter(edm::ParameterSet const& cfg);
    virtual ~daughtersDeltaPhiFilter() {}
 ...
 private:
    ...
    bool IncludeXevt_S_;
    double minDeltaPhi_LambdaKshort_;
