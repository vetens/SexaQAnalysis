#ifndef daughtersDeltaEtaFilter_h
#define daughtersDeltaEtaFilter_h
...
class daughtersDeltaEtaFilter: public edm::EDFilter {

  public:

    explicit daughtersDeltaEtaFilter(edm::ParameterSet const& cfg);
    virtual ~daughtersDeltaEtaFilter() {}
