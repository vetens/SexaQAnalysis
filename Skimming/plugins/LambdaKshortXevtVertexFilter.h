#ifndef LambdaKshortXevtVertexFilter_h
#define LambdaKshortXevtVertexFilter_h
...
class LambdaKshortXevtVertexFilter : public edm::EDFilter {

  public:
    typedef math::XYZPoint Point;
    typedef math::XYZVector Vector;

    explicit LambdaKshortXevtVertexFilter(edm::ParameterSet const& cfg);
    virtual ~LambdaKshortXevtVertexFilter() {}
    ...
    //inline static std::vector<RefCountedKinematicParticle> kshortKinFittedPrevEvent;
    //inline static std::vector<RefCountedKinematicVertex> kshortKinFittedVertexPrevEvent;

    //for looking X events with kshort from 10 prev events:
    inline static std::vector<std::vector<RefCountedKinematicParticle>> kshortKinFittedPrevEvent_collection;
    inline static std::vector<std::vector<RefCountedKinematicVertex>> kshortKinFittedVertexPrevEvent_collection;
