#ifndef daughtersDeltaOpeningsAngleFilter_h
#define daughtersDeltaOpeningsAngleFilter_h
...
class daughtersDeltaOpeningsAngleFilter: public edm::EDFilter {

  public:

    explicit daughtersDeltaOpeningsAngleFilter(edm::ParameterSet const& cfg);
    virtual ~daughtersDeltaOpeningsAngleFilter() {}
 ...
 private:
    ...
    bool IncludeXevt_S_;
    double minOpeningsAngle_LambdaKs_, maxOpeningsAngle_LambdaKs_;
