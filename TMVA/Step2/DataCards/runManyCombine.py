...
masspoints = ["1p7GeV", "1p8GeV", "1p85GeV","1p9GeV", "2GeV"]
#masspoint = "1p7GeV"
...
for masspoint in masspoints:
    ...
    filelist = glob.glob(os.path.join('DataCardsSexaq/', '*'+masspoint+'*.card'))
    ...
    fOut = TFile.Open("Results/combineSexaqResults"+masspoint+".root","RECREATE")
